...
<html>
  <head>
	...
	<%-- <script type="text/javascript" src="<%=basePath%>js/manager/ajaxfileupload.js"></script> --%>
  </head>
   	<%   			
		...
		<div class="">                   
			<table width="100%" border="1" cellspacing="0" cellpadding="0" class="EPTable" style="margin-left:10px;margin-top: 10px;margin-right: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="EPTable_r"><span id="nationality">                        
                        <%
                        	if(user.getEmployee().getEmpOrigin() != null){
                        %>
                        	<%=user.getEmployee().getEmpOrigin()%>
                        <%
                        	}else{
                         %>
                         	-	
                        ...
                        <%
                        	SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");  
  							String sDate = simpleDateFormat.format(user.getEmployee().getEmpBirth());  
                        %>
                        <%=sDate%>
                        </span></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="EPTable_r"><span id="edu">
                        <%
							if(user.getEmployee().getEmpEducation()  != null){
						%>
                        <%=user.getEmployee().getEmpEducation()%>
                       	<%
                       	 }else{
                       	 %>
                       	 	-
                        ...
                        <td class="EPTable_r"><span id="pro">
                        <%
							if(user.getEmployee().getEmpProfession()  != null){
						%>
                        <%=user.getEmployee().getEmpProfession()%>
                       	<%
                       	 }else{
                       	 %>
                       	 	-
                    ...
                    <tr>
                        ...
                        <td class="EPTable_r"><span id="school">
						<%
							if(user.getEmployee().getEmpSchool()  != null){
						%>
                        <%=user.getEmployee().getEmpSchool()%>
                       	<%
                       	 }else{
                       	 %>
                       	 	-
