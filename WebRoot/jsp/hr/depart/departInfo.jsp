...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>js/hr/depart/departInfo.js"></script>
	<script type="text/javascript" src="<%=basePath%>js/hr/process/proAttention.js"></script>
  </head>
	...
	<!------框架右边------->
        <div class="easyui-layout" fit="true"  >  
            ...
            <div region="center" border="false">  
                <table id="departInfo"></table>  
            </div>  
            <div id="main" style="height:400px;margin-top: 260px;"></div>
        </div>
