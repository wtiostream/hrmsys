...
<html>
  <head>
	...
	<link href="<%=basePath%>js/rating/rating/rating_simple.css" rel="stylesheet" type="text/css" />
	<script type="text/javascript" src="<%=basePath%>js/rating/rating/rating_simple.js"></script>
	<script type="text/javascript" src="<%=basePath%>js/hr/train/trainLog.js"></script>
  </head>
