...
function(a) {
    ...
    c.creation = function(a, b) {
        ...
        if(b) {
        	//c.ymd[0] = a[0]; c.ymd[1]=a[1]-1; c.ymd[2]=a[2];
        	c.viewDate(a[0],a[1]-1,a[2]);
        }
        c.elem[h.elemv] = f,
    ...
    c.events = function() {
        ...
        function(a, b) {
            c.on(b, "click",
            function(a) {
                c.hasClass(this, h[1]) || (c.stopmp(a), c.creation([0 | this.getAttribute("y"), 0 | this.getAttribute("m"), 0 | this.getAttribute("d")],1))
            })
        }),
